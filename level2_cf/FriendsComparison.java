...
class FriendsComparison {
    public static void main(String[] args) {
        ...
        // Display results
        System.out.println("The youngest friend is: " + youngestFriend + " and their age is: " + youngestAge + " years.");
        System.out.println("The tallest friend is: " + tallestFriend + " and their height is: " + tallestHeight + " cm.");
